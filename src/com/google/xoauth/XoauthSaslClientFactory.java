 ...
 * 
 * <p>
 * Only the "XOAUTH" mechanism is supported. Only the "imaps" protocol is supported. The {@code callbackHandler} is
 * passed to the XoauthSaslClient. Other parameters are ignored.
 */
public class XoauthSaslClientFactory implements SaslClientFactory {
	...
	public SaslClient createSaslClient(String[] mechanisms, String authorizationId, String protocol, String serverName,
		...
		return new XoauthSaslClient(xoauthProtocol, (String) props.get(OAUTH_TOKEN_PROP),
				(String) props.get(OAUTH_TOKEN_SECRET_PROP), (String) props.get(CONSUMER_KEY_PROP),
				(String) props.get(CONSUMER_SECRET_PROP), callbackHandler);
	}
