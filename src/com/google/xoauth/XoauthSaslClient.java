...
class XoauthSaslClient implements SaslClient {
	...
	/**
	 * Creates a new instance of the XoauthSaslClient. This will ordinarily only be called from XoauthSaslClientFactory.
	 */
	public XoauthSaslClient(XoauthProtocol protocol, String oauthToken, String oauthTokenSecret, String consumerKey,
			String consumerSecret, CallbackHandler callbackHandler) {
