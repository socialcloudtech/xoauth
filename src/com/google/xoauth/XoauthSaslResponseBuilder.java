...
public class XoauthSaslResponseBuilder {
	 ...
	 * @param protocol
	 *            The XoauthProtocol for which to generate an authentication string.
	 * @param tokenAndTokenSecret
	 *            The OAuth token and token_secret.
	 * @param consumer
	 *            The OAuth consumer that is trying to authenticate.
	 * 
	 * @return A byte array containing the auth string suitable for being returned from
	 *         {@code SaslClient.evaluateChallenge}. It needs to be base64-encoded before actually being sent over the
	 *         network.
	 */
	public byte[] buildResponse(String userEmail, XoauthProtocol protocol, String oauthToken, String oauthTokenSecret,
			OAuthConsumer consumer) throws IOException, OAuthException, URISyntaxException {
		...
		String url = String.format("https://mail.google.com/mail/b/%s/%s/", userEmail, protocol.getName());
